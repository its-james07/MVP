...
<body>
  ...
  <div class="store">
    <div class="store-header">
      <span class="store-name"><strong>IKEA Official Store</strong></span>
    </div>
    ...
    <div class="cart-item">
      ...
      <div class="item-info">
        ...
        <h3 class="item-name">Ikea Markus swivel chair</h3>
  ...
  <div class="store">
    <div class="store-header">
      <span class="store-name"><strong>Burrow Official Store</strong></span>
    </div>
  ...
  <div class="cart-item">
      ...
      <div class="item-info">
        <span class="item-category">CHAIR</span>
        <h3 class="item-name">Juss swivel chair</h3>
        <span class="item-details"></span>
