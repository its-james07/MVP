...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 15, 2026 at 08:05 AM
...
--
CREATE DATABASE IF NOT EXISTS `pet_portaldb` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `pet_portaldb`;
...
CREATE TABLE `sellers` (
  ...
  `status` varchar(20) DEFAULT 'pending' CHECK (`status` in ('approved','pending')),
  `created_at` timestamp NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(1, 3, '9875485214', 'pending', '2026-02-14 15:29:31');
...
(1, 1, 'Roman Reigns', 'balaju', 'kathmandu', '2026-02-14 15:29:31', '2026-02-14 15:29:31');
...
INSERT INTO `users` (`user_id`, `fname`, `email`, `password`, `role`) VALUES
(1, 'rajan', 'some@gmail.com', '$2y$10$I1nD0onT1NAYlPVS2m.5jeSVqDaLpdMVa23ESffUws5V9jsA2puXa', 'customer'),
(2, 'roshan', 'roshan@gmail.com', '$2y$10$icidLp5y8EUfpbBKsYnvxun3h6n09oal5EZvq0D9fobIniUlOLD3G', 'user'),
(3, 'romangurung', 'romangurung@gmail.com', '$2y$10$O.zPnh5Xwy2CmAi.rzBg/eb7BcxpR135f/37hTc5.IEEjJF5X3NKy', 'seller');
...
--
ALTER TABLE `addresses`
  ADD CONSTRAINT `addresses_ibfk_1` FOREIGN KEY (`customer_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE;
...
--
ALTER TABLE `shop`
  ADD CONSTRAINT `shop_ibfk_1` FOREIGN KEY (`seller_id`) REFERENCES `sellers` (`seller_id`) ON DELETE CASCADE;
--
-- Database: `phpmyadmin`
--
...
('root', '[{\"db\":\"pet_portaldb\",\"table\":\"shop\"},{\"db\":\"pet_portaldb\",\"table\":\"sellers\"},{\"db\":\"pet_portaldb\",\"table\":\"users\"},{\"db\":\"pet_portaldb\",\"table\":\"products\"},{\"db\":\"pet_portaldb\",\"table\":\"shops\"}]');
...
('root', '2026-02-14 16:45:22', '{\"Console\\/Mode\":\"collapse\"}');
